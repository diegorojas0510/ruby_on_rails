...
# 2-declarar una variable la cual almacenara la formula de BMI peso / altura^2
# 3-Para realizar la validación lo hacemos por medio de una condicional
# imprimir el BMI de la persona de acuerdo a la validación
