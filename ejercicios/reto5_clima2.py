    ...
    with open('data_nuevo.csv', 'w') as file:
        ...
        for i in range(n):
            if location[i]=='1':
                ...
                if presion[i]>pp_loc1:
                    d_pres.append('SI')
                elif presion[i]<pp_loc1:
                    d_pres.append('NO')
                elif presion[i]==pp_loc1:
                    d_pres.append('IGUAL')
            ...
            if location[i]=='2':
                ...
                if presion[i]>pp_loc2:
                    d_pres.append('SI')
                elif presion[i]<pp_loc2:
                    d_pres.append('NO')
                elif presion[i]==pp_loc2:
                    d_pres.append('IGUAL')
            ...
            if location[i]=='3':
                ...
                if presion[i]>pp_loc3:
                    d_pres.append('SI')
                elif presion[i]<pp_loc3:
                    d_pres.append('NO')
                elif presion[i]==pp_loc3:
                    d_pres.append('IGUAL')
            ...
            if location[i]=='4':
                ...
                if presion[i]>pp_loc4:
                    d_pres.append('SI')
                elif presion[i]<pp_loc4:
                    d_pres.append('NO')
                elif presion[i]==pp_loc4:
                    d_pres.append('IGUAL')
            ...
            if location[i]=='5':
                ...
                if presion[i]>pp_loc5:
                    d_pres.append('SI')
                elif presion[i]<pp_loc5:
                    d_pres.append('NO')
                elif presion[i]==pp_loc5:
                    d_pres.append('IGUAL')
